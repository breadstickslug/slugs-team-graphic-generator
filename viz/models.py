...
class Species(models.Model):
    ...
    species_type_2 = models.IntegerField(default=1, null=True, blank=True)
    species_ability_1 = models.IntegerField(default=1)
    species_ability_2 = models.IntegerField(default=1, null=True, blank=True)
    species_ability_3 = models.IntegerField(default=1, null=True, blank=True)
